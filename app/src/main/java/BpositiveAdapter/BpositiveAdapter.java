...
public class BpositiveAdapter extends RecyclerView.Adapter <BpositiveAdapter.viewHolder> {

    ArrayList<BpositiveModel> list;
    Context context;
    Dialog bloodDialog;

    public BpositiveAdapter(ArrayList<BpositiveModel> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public BpositiveAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        BpositiveModel model =list.get(position);
