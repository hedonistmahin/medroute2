...
public class ABnegativeAdapter extends RecyclerView.Adapter <ABnegativeAdapter.viewHolder> {

    ArrayList<ABnegativeModel> list;
    Context context;
    Dialog bloodDialog;

    public ABnegativeAdapter(ArrayList<ABnegativeModel> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public ABnegativeAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ABnegativeModel model =list.get(position);
