...
public class OnegativeAdapter extends RecyclerView.Adapter <OnegativeAdapter.viewHolder> {

    ArrayList<OnegativeModel> list;
    Context context;
    Dialog bloodDialog;

    public OnegativeAdapter(ArrayList<OnegativeModel> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public OnegativeAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull  viewHolder holder, int position) {
        OnegativeModel model =list.get(position);
