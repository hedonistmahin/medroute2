...
public class BnegativeAdapter extends RecyclerView.Adapter <BnegativeAdapter.viewHolder> {

    ArrayList<BnegativeModel> list;
    Context context;
    Dialog bloodDialog;

    public BnegativeAdapter(ArrayList<BnegativeModel> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public BnegativeAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        BnegativeModel model =list.get(position);
