...
public class ABpositiveAdapter extends RecyclerView.Adapter <ABpositiveAdapter.viewHolder> {

    ArrayList<ABpositiveModel> list;
    Context context;
    Dialog bloodDialog;

    public ABpositiveAdapter(ArrayList<ABpositiveModel> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public ABpositiveAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ABpositiveModel model =list.get(position);
