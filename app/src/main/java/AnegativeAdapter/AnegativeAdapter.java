...
public class AnegativeAdapter extends RecyclerView.Adapter <AnegativeAdapter.viewHolder> {

    ArrayList<AnegativeModel> list;
    Context context;
    Dialog bloodDialog;

    public AnegativeAdapter(ArrayList<AnegativeModel> list, Context context) {
      this.list=list;
    ...
    @NonNull
    @Override
    public AnegativeAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
       AnegativeModel model =list.get(position);
