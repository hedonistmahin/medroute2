...
public class ApositiveAdapter extends RecyclerView.Adapter <ApositiveAdapter.viewHolder> {

    ArrayList<ApositiveModel> list;
    Context context;
    Dialog bloodDialog;

    public ApositiveAdapter(ArrayList<ApositiveModel> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public ApositiveAdapter.viewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        ApositiveModel model =list.get(position);
